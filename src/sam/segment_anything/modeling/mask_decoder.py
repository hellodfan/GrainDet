...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.cls_prediction_head = MLP(
            transformer_dim, cls_head_hidden_dim, num_cls, cls_head_depth
        )
    ...
    def predict_masks(
        ...
        output_tokens = torch.cat([self.iou_token.weight, self.cls_token.weight, self.mask_tokens.weight], dim=0)
